...
class funciones_isolucion():
    ...
    def click_multiple(self, tipo, elemento, Tiempo=35):
        if(tipo=="xpath"):
            try:
                val =self.SEX(elemento)
                val.click()
    ...
    def check_multiple(self, tipo, elemento, Tiempo=35):
        if(tipo=="xpath"):
            try:
                val = self.SEX(elemento)
                val.click()
                print("Click en el elemenento {} ".format(elemento))
                t = time.sleep(Tiempo)
                return t
            except TimeoutException as ex:
                print(ex.msg)
    ...
    def check_CSS(self, elemento, Tiempo=1):
    ...
    def select_xpath_type(self, formato ,tipo, elemento, dato, Tiempo):
        if(formato=="xpath"):
            try:
                val = self.SEX(elemento)
                val=Select(val)
